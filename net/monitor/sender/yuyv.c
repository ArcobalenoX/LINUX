...
static int read_frame (void)
{
	...
	jpeg_show_buf(dest,ret,0,0,1); //显示图片 ,dest==jpeg图片数据，ret==图片字节数
	
	//使用udp把采集到的数据发送到其它开发板
	printf("snd:%lu\n", ret);
...
//收到10号 信号 后 ， 改变拍照的标示变量
void signal_cap(int sig){
